...
| `custom_attribute_dictionary` | URL | Optional | The data dictionary containing information on the elements and values added into the `custom_attributes` for Curb Zones. This should include the attribute name, type, and description of what the attribute represents. |
