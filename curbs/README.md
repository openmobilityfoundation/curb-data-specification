...
|--------------|---------------------------------------------------------------------------------------------------------------------|-----------------|-----------------|-------------------|------------------|----------------|
| parking      | pay stop and leave vehicle unattended                                                                               | ✅               | ✅               | ✅                 | ✅                | ?              |
| no parking   | may not stop and leave vehicle unattended                                                                           | ❌               | ✅               | ✅                 | ✅                | ?              |
| loading      | loading of goods                                                                                                    | ❌               | ✅               | ?                 | ✅                | ?              |
| no loading   | no loading allowed                                                                                                  | ❌               | ❌               | ?                 | ✅                | ?              |
| unloading    | unloading of goods                                                                                                  | ❌               | ?               | ✅                 | ✅                | ?              |
| no unloading | no unloading allowed                                                                                                | ❌               | ?               | ❌                 | ✅                | ?              |
