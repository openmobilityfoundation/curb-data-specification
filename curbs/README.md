...
| `max_stay`       | Integer                                      | Optional          | The length of time (in units of `max_stay_unit`) for which the curb may be used under this regulation. If not specified, the curb may be used under this regulation indefinitely.                                                                                                                                                                                                                                                                                                                                                                            |
...
| `no_return`      | Integer                                      | Optional          | The length of time (in units of `no_return_unit`) that a user must vacate a Curb Zone before being allowed to return for another stay. Defaults to 0.                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `rate_unit`         | Enum    | Required          | The [Unit of Time Enum](/general-information.md#unit-of-time-enum) associated with the rate.                                                                                                                                                                  |
